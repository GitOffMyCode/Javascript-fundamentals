...
console.log(`Hello my name is ${myName} I am aged ${myAge} and I am a ${mySex}`);
// - - - - - - - - - - - - - - 
...
function ONE() {
  let myName = 'Genna';
  console.log(`OUTER FUNCTION: My name is ${myName} but I can\'t access my age here!`);
...
// nested arrays
let boxes = [ ['paints', 'brushes'], ['paper', 'pens', 'glue'] ]
...
let husband = 'Carl';
let daughter = 'Ada';
while(husband === 'Carl' && daughter === 'Ada'){
    console.log(`I am married to ${husband} and have a lovely daughter called ${daughter}`)
    break;
}
// - - - - - - - - - - - - - - 
...
let dwarves = ['Sneezy', 'Sleepy', 'Dopey', 'Doc', 'Happy', 'Bashful',
'Grumpy'];
...
var genna = {
  ...
  age: 45,
  location: 'Stockport',
  'current occupation': 'Senior Self Care Coordinator',
  sayAgeAndName() {  /// this is an anonymous function
...
var myCup = {
  ...
  cost: 14.99,
	printCup(){
        console.log('This is my favourite ' + this.colour + ', ' + this.material + ' cup. It was well worth ' + this.cost);
    },
        ...
        temperature : 'hot',
        printDrink() {
            console.log('Lovely, ' + this.temperature + ' cup of ' + this.liquid + ' in my favourite ' + myCup.material + ' cup!');
        }
        },
}
myCup.printCup();
...
const myCar = {
  ...
  colour: 'black',
  mileage: 23000,
  getCar() {  // can call this getCar or whatever u want
...
const zombie = monsterFactory('Rigor Mortis', 900, 'living flesh', 'uuggggggghhhh!')
ghost.scare(); 
zombie.scare();
// - - - - - - - - - - - - -
